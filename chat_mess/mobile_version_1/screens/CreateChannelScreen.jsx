...
function CreateChannelScreen({ navigation }) {
  ...
  const colors = {
    bg: isDarkMode ? "#0D0D12" : "#F0F4FF",
    surface: isDarkMode ? "#161B2E" : "#FFFFFF",
    surfaceElevated: isDarkMode ? "#1C2240" : "#FAFCFF",
    text: isDarkMode ? "#E8ECFF" : "#0F1A3D",
    textSecondary: isDarkMode ? "#8890B5" : "#5A6490",
    border: isDarkMode ? "#252D50" : "#DDE4F8",
    placeholder: isDarkMode ? "#4A5280" : "#99A3C8",
    gradient1: "#00C2FF",
    gradient2: "#6366F1",
    gradient3: "#818CF8",
    accent: "#00C2FF",
    accentLight: isDarkMode ? "rgba(59, 130, 246, 0.15)" : "rgba(59, 130, 246, 0.08)",
    switchTrackOff: isDarkMode ? "#252D50" : "#CBD5EE",
  };
  ...
  const onCreateChannel = async () => {
    ...
    try {
      ...
      console.log("Канал создан:", response.data);
      navigation.goBack();
    } catch (err) {
      console.log(
      ...
      alert("Не удалось создать канал. Пожалуйста, попробуйте снова.");
    } finally {
      setIsCreating(false);
    }
  };
                ...
                <View style={styles.switchLeft}>
                  ...
                  <View>
                    ...
                    <Text style={[styles.switchHint, { color: colors.textSecondary }]}>
                      {isPublic ? "Все могут найти и подписаться" : "Только по приглашению"}
                    </Text>
                  </View>
                </View>
                <Switch
          ...
          >
            ...
            >
              {isCreating ? (
                ...
                <>
                  <Ionicons name="megaphone" size={20} color="#fff" style={{ marginRight: 10 }} />
