...
/**
 * Talkify canvas — midnight gradient with soft accent blooms for depth.
 * Premium wellness-app atmosphere: colour washes, never decorative clutter.
 */
export function AuroraBackground({ children, style, palette = colors }: { children?: ReactNode; style?: ViewStyle; palette?: Palette }) {
  return (
    <View style={[styles.root, style]}>
      <LinearGradient
        colors={[palette.bg, palette.bg2, palette.bg3]}
        start={{ x: 0.5, y: 0 }}
        end={{ x: 0.5, y: 1 }}
