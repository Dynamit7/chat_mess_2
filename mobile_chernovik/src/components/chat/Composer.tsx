...
const makeStyles = (c: Palette) => StyleSheet.create({
  ...
  banner: { flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: c.glass2, borderRadius: radius.lg, padding: 12, borderWidth: 1, borderColor: c.stroke },
  ...
  attach: {
    width: 48, height: 48, borderRadius: radius.full, backgroundColor: c.glass2, borderWidth: 1, borderColor: c.stroke,
    alignItems: 'center', justifyContent: 'center',
  },
  inputWrap: {
    flex: 1, flexDirection: 'row', alignItems: 'center',
    backgroundColor: c.input, borderWidth: 1, borderColor: c.stroke, borderRadius: radius.full,
    paddingLeft: 18, paddingRight: 8, minHeight: 48, maxHeight: 130,
    shadowColor: '#000', shadowOpacity: 0.08, shadowRadius: 8, shadowOffset: { width: 0, height: 2 }, elevation: 2,
  },
  input: { flex: 1, color: c.text, fontFamily: font.body, fontSize: 16, paddingVertical: 11 },
  emojiBtn: { width: 38, height: 38, alignItems: 'center', justifyContent: 'center' },
  emojiPanel: { marginHorizontal: -14 },
  send: { width: 48, height: 48, borderRadius: radius.full, alignItems: 'center', justifyContent: 'center' },
  sendRec: { transform: [{ scale: 1.1 }] },
  recBar: {
