...
export function AddMembersSheet({ visible, myId, title = 'Добавить участника', excludeIds = [], onClose, onPick }: Props) {
      ...
      <View style={[styles.sheet, { paddingBottom: insets.bottom + 16 }]}>
        ...
        {loading ? (
          ...
          <View style={styles.center}>
            ...
            <Text style={styles.empty}>{touched ? 'Никого не найдено' : 'Введите имя для поиска'}</Text>
          </View>
        ) : (
          <FlatList
            data={visibleResults}
