...
/** Brand lockup: a glowing maroon orb + the Rossi wordmark. */
  ...
  return (
    <View style={styles.row}>
      <View style={{ width: orb, height: orb }}>
        {/* outer glow halo */}
        <LinearGradient
          colors={['rgba(163,0,0,0.65)', 'rgba(163,0,0,0.0)']}
          start={{ x: 0, y: 0 }}
          end={{ x: 1, y: 1 }}
        ...
        >
          ...
          />
          <Text style={[styles.glyph, { fontSize: orb * 0.46 }]}>R</Text>
        </LinearGradient>
      </View>
      {size === 'lg' && (
        <View>
          <Text style={styles.word}>Rossi</Text>
