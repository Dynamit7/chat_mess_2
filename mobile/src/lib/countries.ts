/**
 * Country dial-code data for the phone-number input (Telegram-style picker).
 * Flags are derived from the ISO-3166 alpha-2 code at runtime (regional-indicator
 * emoji), so there's nothing to keep in sync — just name + iso2 + dial.
 */
...
/** Alphabetical by name. Covers every country + common territories. */
...
export const countryByIso = (iso2: string): Country | undefined =>
